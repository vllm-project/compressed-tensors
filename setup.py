...
def _setup_install_requires() -> List:
    return ["torch>=2.10.0", "transformers>=4.45.0", "pydantic>=2.0", "loguru", "psutil"]

def _setup_extras() -> Dict:
    return {
        "dev": ["black==22.12.0", "isort==5.8.0", "wheel>=0.36.2", "flake8>=3.8.3", "pre-commit>=4.0.0", "pytest>=6.0.0", "nbconvert>=7.16.3", "accelerate", "datasets"],
        "accelerate": ["accelerate"],
        "docs": ["mkdocstrings-python", "zensical", "markdown", "pymdown-extensions"],
    }
